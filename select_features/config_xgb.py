...
FEATS = ['elevation', 'path', 'swir1_sd', 'lat', 'red_raw',# 'rn',
       ...
       'TOT_SILTAVE', 'TOT_CLAYAVE', 'type_Stream', 'type_Estuary', 'type_Facility', 'type_Lake','RESOLUTION_Medium',
       'FLOWDIR_With Digitized', 'WBAreaType_StreamRiver'] #I added type_lake/estuary/facility here (133 total feats)
